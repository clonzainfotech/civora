        ...
        abortionData +=
            ...
            "<div class='col-md-4'>"+
                "<div class='input-group'>"+
                    ...
                    '<input type="text" name="p_obstratics[abortion][abortion_data]['+i+'][reason]" class="form-control">'+
                "</div>"+
            "</div>"+
            "</div>";
    }
    ...
    for (i = j; i <= secondAbortionNo; i++) {
        secondAbortionData +=
            ...
            "<div class='col-md-4 second-marriage-life-data'>"+
                "<div class='input-group'>"+
                    "<span class='input-group-addon'>Abortion Reason : &nbsp;</span>"+
                    '<input type="text" name="p_obstratics[second_marriage][abortion][abortion_data]['+i+'][reason]" class="form-control">'+
                "</div>"+
            "</div>"+
            "</div>";
    }
...
function ectopicData(ectopicNo){
    ...
    for (i = j; i <= ectopicNo; i++) {
        ectopicData +=
            ...
            "<div class='col-md-3'>"+
            "<div class='radio is-conceived'>"+
            '<input type=radio name="p_obstratics[ectopic][ectopic_data]['+i+'][spontancous_ectopic_type]" value="medically" id="spontancous_ectopic_medically_'+i+'"><label for="spontancous_ectopic_medically_'+i+'">Medically</label>'+
            '<input type=radio name="p_obstratics[ectopic][ectopic_data]['+i+'][spontancous_ectopic_type]" value="surgically" id="spontancous_ectopic_surgically_'+i+'"><label for="spontancous_ectopic_surgically_'+i+'">Surgically</label>'+
            "</div>"+
            "</div>"+
            "<div class='col-md-4'>"+
            "<div class='input-group'>"+
            "<span class='input-group-addon'>Before &nbsp;</span>"+
            '<input type="text" name="p_obstratics[ectopic][ectopic_data]['+i+'][spontancous_ectopic_before]" class="form-control">'+
            "</div>"+
            "</div>"+
            '<div class="col-sm-2">'+
                '<div class="checkbox">'+
                    '<input type="checkbox" name="p_obstratics[ectopic][ectopic_data][1][tube][]" id="right_tube_'+i+'" value="right"><label for="right_tube_'+i+'">Right Tube</label>'+
                '</div>'+             
            '</div>'+  
            '<div class="col-sm-2">'+
                '<div class="checkbox">'+
                    '<input type="checkbox" name="p_obstratics[ectopic][ectopic_data][1][tube][]" id="left_tube_'+i+'" value="left"><label for="left_tube_'+i+'">Left Tube</label>'+
                '</div>'+             
            '</div>'+    
            "</div>"+
            "</div>"+
            ...
            "<div class='form-group'>"+
            '<select name="p_obstratics[ectopic][ectopic_data]['+i+'][ho_type]" class="form-control select-padding-0 child-ho-type p-ho-type" data-id="ectopic-when-where-'+i+'">'+
            '<option value="">Select Conceived By</option>'+
            '<option value="1">Naturally</option>'+
            '<option value="2">Medicine</option>'+
            '<option value="3">IUI</option>'+
            ...
            "<div class='input-group'>"+
            "<span class='input-group-addon'>When / Where : &nbsp;</span>"+
            '<input type="text" name="p_obstratics[ectopic][ectopic_data]['+i+'][when_where]" class="form-control">'+
            "</div>"+
            "</div>"+
            "<div class='col-md-4'>"+
                "<div class='input-group'>"+
                    "<span class='input-group-addon'>Ectopic Detail: &nbsp;</span>"+
                    '<input type="text" name="p_obstratics[ectopic][ectopic_data]['+i+'][detail]" class="form-control">'+
                "</div>"+
            "</div>"+
            "</div>";
    }
...
function secondEctopicData(secondEctopicnNo)
{
    ...
    for (i = j; i <= secondEctopicnNo; i++) {
        secondEctopicData +=
            ...
            "<div class='col-md-3'>"+
            "<div class='radio is-conceived'>"+
            '<input type=radio name="p_obstratics[second_marriage][ectopic][ectopic_data]['+i+'][spontancous_ectopic_type]" value="medically" id="second_spontancous_ectopic_medically_'+i+'"><label for="second_spontancous_ectopic_medically_'+i+'">Medically</label>'+
            '<input type=radio name="p_obstratics[second_marriage][ectopic][ectopic_data]['+i+'][spontancous_ectopic_type]" value="surgically" id="second_spontancous_ectopic_surgically_'+i+'"><label for="second_spontancous_ectopic_surgically_'+i+'">Surgically</label>'+
            "</div>"+
            "</div>"+
            "<div class='col-md-4'>"+
            "<div class='input-group'>"+
            "<span class='input-group-addon'>Before &nbsp;</span>"+
            '<input type="text" name="p_obstratics[second_marriage][ectopic][ectopic_data]['+i+'][spontancous_ectopic_before]" class="form-control">'+
            "</div>"+
            "</div>"+
            '<div class="col-sm-2">'+
                '<div class="checkbox">'+
                    '<input type="checkbox" name="p_obstratics[second_marriage][ectopic][ectopic_data][1][tube][]" id="second_right_tube_'+i+'" value="right"><label for="second_right_tube_'+i+'">Right Tube</label>'+
                '</div>'+             
            '</div>'+  
            '<div class="col-sm-2">'+
                '<div class="checkbox">'+
                    '<input type="checkbox" name="p_obstratics[second_marriage][ectopic][ectopic_data][1][tube][]" id="second_left_tube_'+i+'" value="left"><label for="second_left_tube_'+i+'">Left Tube</label>'+
                '</div>'+             
            '</div>'+                                            
            "</div>"+
            "</div>"+
            ...
            "<div class='form-group'>"+
            '<select name="p_obstratics[second_marriage][ectopic][ectopic_data]['+i+'][ho_type]" class="form-control select-padding-0 child-ho-type second-p-ho-type" data-id="second-ectopic-when-where-'+i+'">'+
            '<option value="">Select Conceived By</option>'+
            '<option value="1">Naturally</option>'+
            '<option value="2">Medicine</option>'+
            '<option value="3">IUI</option>'+
            ...
            "<div class='input-group'>"+
            "<span class='input-group-addon'>When / Where : &nbsp;</span>"+
            '<input type="text" name="p_obstratics[second_marriage][ectopic][ectopic_data]['+i+'][when_where]" class="form-control">'+
            "</div>"+
            "</div>"+
            "<div class='col-md-4 second-marriage-life-data'>"+
                "<div class='input-group'>"+
                    "<span class='input-group-addon'>Ectopic Reason : &nbsp;</span>"+
                    '<input type="text" name="p_obstratics[second_marriage][ectopic][ectopic_data]['+i+'][reason]" class="form-control">'+
                "</div>"+
            "</div>"+
            "</div>";
    }
