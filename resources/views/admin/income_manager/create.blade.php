...
@section('content')
    <div class="row clearfix income">
        <div class="col-md-12">
            <div class="card">
                <div class="header">
                    <h2><strong>Add Income</strong></h2>
                ...
                <div class="body">
                    <div class="col-md-12 col-lg-12">
                        ...
                        {{Form::open(['method'=>'post','class'=>'form appointment-form income-form','files'=>'true'])}}
                            ...
                            <div class="panel panel-primary">
                                <div class="panel-heading" role="tab" id="headingThree_1">
                                    <h4 class="panel-title"> <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion_1" href="#patients" aria-expanded="true"
                                                                aria-controls="patients"> Add Income</a> </h4>
                                </div>
                                    ...
                                    <div class="panel-body">
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-md-4 col-sm-12">
                                                <div class="form-group">
                                                    {{Form::select('incomecategory',$expensecategory,!empty($patientData->getAppointment['category_id']) ? $patientData->getAppointment['category_id'] : null,['class'=>'form-control select-padding-0 category_data','placeholder'=>'Select Category','required'])}}
                                                </div>
                                                <span class="form-error-msg">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    {{Form::text('given_by','',['class'=>'form-control given_by','placeholder'=>'Given by','required'])}}
                                                </div>
                                                <span class="form-error-msg">
