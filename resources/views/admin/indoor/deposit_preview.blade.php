        ...
        <tr>
            <td>
                <table class="deposite-receipt" cellpadding="0" cellspacing="0">
                    <thead>
                    <tr>
                        <th class="deposit-receipt-th text-center">Deposit Receipt</th>
                    </tr>
                    </thead>
                </table>
            </td>
        ...
        <tr>
            <td>
                <table class="deposit-data deposit" cellpadding="0" cellspacing="0">
                    ...
                    <tbody>
                    <tr>
                        <td colspan="2" class="text-right">Date : {{\Carbon\Carbon::now('Asia/Kolkata')->format('d-m-Y')}}</td>
                    </tr>
                    <tr>
                        <td><h4>Received With Thanks From</h4></td>
                    </tr>
                    <tr>
                        <td class="text-center deposit-patient-name"><h3>{{$deposit->getPatients['name']}}</h3></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td class="text-center"><h3>{{$depositAmount}}</h3></td>
                    </tr>
                    <tr>
                        <td>Operator Name: {{$deposit->getUsers['name']}}</td>
