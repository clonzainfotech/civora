<table class="table m-b-0 table-hover font">
    ...
    @if ($count > 0)
        ...
        {{-- new old cash --}}
        {{-- <tr>
            <th colspan="12" class="sub-headline">NEW - OLD</th>
        </tr>
        @include('admin.report.collection.collection_data', [
            'data' => $newOldCash
        ])
        ...
        {{-- end new old cash --}}
        {{-- <tr>
            <th colspan="12" class="sub-headline">OLD</th>
        </tr>
        @include('admin.report.collection.collection_data', [
            'data' => $oldCash
        ])
        ...
        {{-- <tr>
            <th colspan="12" class="sub-headline">Swipe</th>
        </tr>
        ...
        <tr>
            <th colspan="12" class="sub-headline">Cheque</th>
        </tr>
        ...
        <tr>
            <th colspan="12" class="sub-headline">UPI</th>
        </tr>
        ...
        <tr>
            <th colspan="12" class="sub-headline">NEFT</th>
        </tr>
...
@if(count($income) != 0 || count($expense) !=0 )
    <table  class="table m-b-0 table-hover font">
        ...
        @if ($count > 0)
            ...
            @if ($debitCount > 0)
                <tr>
                    <th colspan="12" class="sub-headline">Debit</th>
                </tr>
