                            ...
                            <div class="col-md-3">
                                <ul class="nav nav-tabs padding-0">
                                    <div class="input-group">
                                        <input type="text" class="form-control search-remark" placeholder="Search by Remark">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $(document).on('click', '.pagination a',function(event){
                ...
                qstring = 'page='+page+'&patient_id='+patientId+'&search='+search+'&patient_status='+patientStatus+'&ref_pro_id='+refProId;
                getRemarkAppointmentData(qstring);
            });
